...
class je extends B {
  ...
  addView(e, t, i, n, r) {
    ...
    var o = this.orientation === ye.Vertical ? new Ve(e, t, s) : new Ee(e, t, s);
    if (this.viewItems.splice(n, 0, o), this.viewItems.length > 1) {
      var _e6 = this.orientation === ye.Vertical ? new we(this.sashContainer, {
  ...
  layout(e) {
    ...
    if (this.size = e, this.proportions) for (var _t4 = 0; _t4 < this.viewItems.length; _t4++) {
      ...
      _i3.size = S(Math.round(this.proportions[_t4] * e), _i3.minimumSize, _i3.maximumSize);
    } else {
      var _i4 = G(0, this.viewItems.length),
        _n2 = _i4.filter(e => this.viewItems[e].priority === Ie.Low),
        _r2 = _i4.filter(e => this.viewItems[e].priority === Ie.High);
  ...
  resizeViews(e) {
    for (var _t5 = 0; _t5 < e.length; _t5++) {
      ...
      var _n3 = e[_t5];
      _n3 = Math.round(_n3), _n3 = S(_n3, _i5.minimumSize, Math.min(_i5.maximumSize, this.size)), _i5.size = _n3;
    }
  ...
  distributeViewSizes() {
    ...
    for (var _t6 of e) _t6.size = S(i, _t6.minimumSize, _t6.maximumSize);
  ...
  resize(e, t, i, n, r, s, o, a, u) {
    ...
    if (r) for (var _e9 of r) R(c, _e9), R(h, _e9);
    if (n) for (var _e10 of n) W(c, _e10), W(h, _e10);
    ...
    for (var _e13 = 0, _i10 = t = S(t, g, z); _e13 < l.length; _e13++) {
      var _t9 = l[_e13],
        _n4 = S(f[_e13] + _i10, _t9.minimumSize, _t9.maximumSize);
      _i10 -= _n4 - f[_e13], _t9.size = _n4;
    }
    for (var _e14 = 0, _i11 = t; _e14 < m.length; _e14++) {
      var _t10 = m[_e14],
        _n5 = S(d[_e14] - _i11, _t10.minimumSize, _t10.maximumSize);
  ...
  updateSashEnablement() {
    ...
    for (var _e16 = 0; _e16 < this.sashItems.length; _e16++) {
      ...
      if (_a && _u) {
        var _i12 = G(_e16, -1, -1),
          _s = G(_e16 + 1, this.viewItems.length),
        ...
        _c && r[_e16] && (o > 0 || this.startSnappingEnabled) ? _n6.state = be.Minimum : _h && t[_e16] && (o < this.contentSize || this.endSnappingEnabled) ? _n6.state = be.Maximum : _n6.state = be.Disabled;
      } else _n6.state = _a && !_u ? be.Minimum : !_a && _u ? be.Maximum : be.Enabled;
    }
  }
  ...
  set preferredSize(e) {
    if ("number" == typeof e) this.layoutStrategy = new Ne(e);else if ("string" == typeof e) {
      ...
      if (H(_t15, "%")) {
        ...
        this.layoutStrategy = new Le(_e19, this.layoutService);
      } else if (H(_t15, "px")) {
        var _e20 = Number(_t15.slice(0, -2)) / 100;
        this.layoutStrategy = new Ne(_e20);
      } else if ("number" == typeof Number.parseFloat(_t15)) {
        var _e21 = Number.parseFloat(_t15);
        this.layoutStrategy = new Ne(_e21);
  ...
  constructor(e, t) {
    ...
    if (this.minimumSize = 0, this.maximumSize = Number.POSITIVE_INFINITY, this.element = void 0, this.priority = void 0, this.snap = void 0, this.layoutService = void 0, this.layoutStrategy = void 0, this.layoutService = e, this.element = t.element, this.minimumSize = "number" == typeof t.minimumSize ? t.minimumSize : 30, this.maximumSize = "number" == typeof t.maximumSize ? t.maximumSize : Number.POSITIVE_INFINITY, "number" == typeof t.preferredSize) this.layoutStrategy = new Ne(t.preferredSize);else if ("string" == typeof t.preferredSize) {
      ...
      if (H(_e22, "%")) {
        ...
        this.layoutStrategy = new Le(_t16, this.layoutService);
      } else if (H(_e22, "px")) {
        var _t17 = Number(_e22.slice(0, -2));
        this.layoutStrategy = new Ne(_t17);
      } else if ("number" == typeof Number.parseFloat(_e22)) {
        var _t18 = Number.parseFloat(_e22);
        this.layoutStrategy = new Ne(_t18);
      } else this.layoutStrategy = new Oe();
    } else this.layoutStrategy = new Oe();
  ...
  return u(_, () => ({
    reset: () => {
      if (g) g();else {
        ...
        for (var _e23 = 0; _e23 < F.current.length; _e23++) R(_e23);
      }
    },
    resize: e => {
      var _P$current3;
    ...
    var t = _extends({
      ...
      descriptor: {
        ...
        views: p.map((e, t) => {
          ...
          var i = L.current.get(j.current[t]),
    ...
    P.current = new je(x.current, t, b, w, S), P.current.on("sashDragStart", () => {
      ...
      if (z && P.current) {
        ...
        for (var _t19 = 0; _t19 < _e24.length; _t19++) {
          var _i13 = L.current.get(_e24[_t19]);
    ...
    if (H) {
      var _e25 = B.map(e => e.key),
        _t20 = [...j.current],
        _i14 = _e25.filter(e => !j.current.includes(e)),
        _n7 = _e25.filter(e => j.current.includes(e)),
        _r4 = j.current.map(t => !_e25.includes(t));
      for (var _e26 = _r4.length - 1; _e26 >= 0; _e26--) {
        var _P$current5;
        _r4[_e26] && ((_P$current5 = P.current) != null && _P$current5.removeView(_e26), _t20.splice(_e26, 1), F.current.splice(_e26, 1));
      }
      var _loop = function _loop(_n8) {
        var _i$minSize2, _i$maxSize2, _i$priority2, _i$snap2, _P$current7;
        var i = L.current.get(_n8),
          r = new De(T.current, _extends({
            element: document.createElement("div"),
            ...
            priority: (_i$priority2 = i == null ? void 0 : i.priority) != null ? _i$priority2 : Ie.Normal
          }, (i == null ? void 0 : i.preferredSize) && {
            preferredSize: i == null ? void 0 : i.preferredSize
          }, {
            snap: (_i$snap2 = i == null ? void 0 : i.snap) != null ? _i$snap2 : v
          }));
        (_P$current7 = P.current) != null && _P$current7.addView(A.current.get(_n8), r, Se.Distribute, _e25.findIndex(e => e === _n8)), _t20.splice(_e25.findIndex(e => e === _n8), 0, _n8), F.current.splice(_e25.findIndex(e => e === _n8), 0, r);
      };
      for (var _n8 of _i14) {
        _loop(_n8);
      }
      ...
      var _loop4 = function _loop4(_t22) {
        ...
        var i = L.current.get(_t22),
          n = _e25.findIndex(e => e === _t22);
        i && Me(i) && void 0 !== i.visible && ((_P$current9 = P.current) == null ? void 0 : _P$current9.isViewVisible(n)) !== i.visible && ((_P$current10 = P.current) == null ? void 0 : _P$current10.setViewVisible(n, i.visible));
      };
      for (var _t22 of [..._i14, ..._n7]) {
        _loop4(_t22);
      }
      var _loop5 = function _loop5(_t23) {
        var i = L.current.get(_t23),
        ...
        if (i && Me(i)) {
          ...
          var _e27 = !1;
          void 0 !== i.minSize && F.current[n].minimumSize !== i.minSize && (F.current[n].minimumSize = i.minSize, _e27 = !0), void 0 !== i.maxSize && F.current[n].maximumSize !== i.maxSize && (F.current[n].maximumSize = i.maxSize, _e27 = !0), _e27 && ((_P$current11 = P.current) == null ? void 0 : _P$current11.layout());
        }
      };
      for (var _t23 of _n7) {
        _loop5(_t23);
      }
      (_i14.length > 0 || _r4.length > 0) && (j.current = _e25);
    }
  }, [B, H, c, h, v]), n(() => {
    ...
    if (!H) {
      ...
      (_P$current13 = P.current) != null && _P$current13.layout(y ? _e28 : _t24), T.current.setSize(y ? _e28 : _t24), Y(!0);
    }
  }, [H, y]), n(() => {
    C && Te(20);
  }, []), e.createElement("div", {
